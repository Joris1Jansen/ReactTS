...
interface LoadSuccesAction extends Action<typeof LOAD_SUCCESS> {
  payload: {
    events: UserEvent[];
  };
}
...
export const loadUserEvents =
  (): ThunkAction<
    ...
    RootState,
    undefined,
    LoadRequestAction | LoadSuccesAction | LoadFailureAction
  > =>
...
interface CreateFailureActin extends Action<typeof CREATE_FAILURE> {}
...
export const createUserEvent =
  (): ThunkAction<
    ...
    RootState,
    undefined,
    CreateRequestAction | CreateSuccessAction | CreateFailureActin
  > =>
  async (dispatch, getState) => {
    dispatch({
      type: CREATE_REQUEST,
